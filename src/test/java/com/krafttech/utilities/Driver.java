            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    ...
                    try{
                       ...
                       // driverPool.set(new RemoteWebDriver(new URL("http://192.168.1.104:4444/wd/hub"),chromeOptions));
                ...
                case "remote_firefox":
                    ...
                    try{
                        ...
                        //driverPool.set(new RemoteWebDriver(new URL("http://192.168.1.104:4444/wd/hub"),firefoxOptions));
                    }catch (MalformedURLException e){
                        e.printStackTrace();
                    }
                    break;
